  ...
  return (
    <div className="intro bg-primary flex flex-col items-center justify-center text-center relative">
      ...
      <div className="h-[40vh] flex flex-col items-center justify-center gap-5 py-10 relative z-1">
        ...
        <p className="phrase text-fifth opacity-50 lg:text-sm font-mono">
          Omniscient being with supernatural powers of controlling computers at
          will.
        </p>
      ...
      <button
        ...
        className="border-[1px] text-sm sm:text-sm font-mono border-secondary text-secondary px-10 py-2 rounded resume-button"
      >
        Resume / CV
      </button>
    </div>
