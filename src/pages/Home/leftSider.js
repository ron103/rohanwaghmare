    ...
    <div className="lfsider fixed left-0 bottom-0 px-10 sm:static">
      <div className="flex flex-col gap-5">
        <div className="flex flex-col items-center justify-center gap-3 sm:flex-row" >
          <div onClick={openEmail}><i className="icons ri-mail-fill text-gray-600 text-xl" /></div>
          <a href="https://www.instagram.com/rohannwaghmare">
          <i className="icons ri-instagram-line text-gray-600 text-xl"></i></a>
          <a href="https://www.github.com/ron103">
          <i className="icons ri-github-fill text-gray-600 text-xl"></i></a>
          <a href="https://www.linkedin.com/in/rohanwaghmare">
          <i className="icons ri-linkedin-box-fill text-gray-600 text-xl"></i></a>
